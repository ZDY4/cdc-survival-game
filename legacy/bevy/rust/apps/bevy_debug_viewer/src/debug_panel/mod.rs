...
use state::{
    max_console_scroll_offset, DebugPanelBodyRoot, DebugPanelButtonAction, DebugPanelFeedback,
    DebugPanelRoot, DebugPanelTab, DebugPanelTextFocus,
};
...
const DEBUG_PANEL_VISIBLE_COMMAND_ROWS: usize = 8;
