//! NPC life 后台执行系统。
//! 负责离线 action 推进与背景态刷新，不负责在线 runtime movement 或 combat bridge。
...
use super::super::components::{
    BackgroundLifeState, NeedState, NpcActiveOfflineAction, NpcLifeState, NpcPlannedActionQueue,
    ReservationState,
};
use super::super::helpers::{quantize_need, resolve_anchor_grid};
use super::super::resources::SimClock;
