...
pub use map::{
    ...
    validate_map_exit_coverage, BuildingGeneratorKind, MapAiSpawnProps, MapBuildingDiagonalEdge,
    ...
    MapEntryPointDefinition, MapExitCoverageValidationError, MapId, MapInteractiveProps,
    MapLevelDefinition, MapLibrary, MapLoadError, MapObjectDefinition, MapObjectFootprint,
    MapObjectKind, MapObjectProps, MapObjectVisualSpec, MapPickupProps, MapRotation, MapSize,
