...
use game_data::{
    ...
    MapBuildingStairSpec, MapBuildingStorySpec, MapCellDefinition, MapContainerProps,
    ...
    MapPickupProps, MapRotation, MapSize, MapTriggerProps, OverworldCellDefinition,
