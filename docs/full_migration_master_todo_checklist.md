...
- [~] 拖拽交易和装备出售确认第一版已迁移：shop / inventory / equipment 可拖入购物车或 buy/sell drop zone，drop zone 来源提示、hover 高亮、drag preview 文案、接受/拒绝诊断和业务禁用说明已纳入 `TradeUI` smoke；待补快捷键和统一 drag preview layer polish。
