...
- [~] `Esc` 关闭链路：已覆盖 selection、dialogue、interaction menu、trade modal、container modal、stage panels、settings、pending movement 和无活动 UI 时打开 settings；待补 quantity modal、discard modal、overworld prompt、pending interaction 细分优先级和 blocker 诊断。
