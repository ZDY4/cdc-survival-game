...
- `godot/scripts/app/game_app.gd` 仍约 2133 行，还保留 tooltip / drag snapshot facade、overlay 兼容属性、observe / pending 分支、移动/交互等兼容入口。
...
- [ ] 将移动 / 交互、observe / pending 分支等剩余玩家动作 facade 继续从 `GameApp` 移出。
