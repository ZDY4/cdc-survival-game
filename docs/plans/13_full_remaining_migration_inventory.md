...
- 部分迁移 interaction menu：右键位置、目标名称、主动作/可用/禁用摘要、可用选项、禁用选项、禁用原因本地化 tooltip、稳定 reason metadata / snapshot、按钮 hover 详情、Esc / 外部点击关闭和 `ui_layer_stack_snapshot()` context menu 层级诊断第一版已有；待补更完整视觉布局和上下文菜单 polish。
