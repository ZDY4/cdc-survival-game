...
- Journal 详情第一版已迁移：目标节点、任务描述、目标类型/需求、进度、可交付状态、奖励详情和本地追踪 marker 已纳入 `JournalUI` smoke；待补完成/失败历史、HUD/地图追踪 marker 和更完整进度列表。
...
- Journal 面板已有任务详情、可交付状态、奖励详情和本地追踪 marker 第一版；待补完成/失败历史、HUD/地图追踪、奖励领取反馈。
...
- `JournalUI`：任务详情、目标需求、奖励详情、可交付状态和本地追踪 marker 第一版已有 smoke；待补对话交付条件、完成/失败历史、HUD/地图追踪和完成反馈。
