...
- 旧 Bevy editor 聚合 smoke、旧 Bevy workflow 文档、Bevy-only 地图 AI 维护文档、迁移前 Bevy/Rust playable 计划、Bevy runtime 配置和旧 smoke 产物已移入 `legacy/bevy/`，不再位于默认 agent/editor/plans/config 文档或配置路径。
