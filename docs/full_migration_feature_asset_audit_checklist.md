...
- [~] inventory order：actor snapshot/save roundtrip、核心增删维护和 Inventory 默认顺序排序第一版已迁移；待补拖拽重排。
...
- [ ] `AI`：感知、追击、攻击、回合、日程。
- [~] `InventoryUI`：使用、装备、丢弃、丢弃数量、排序、筛选、搜索、详情第一版已迁移；待补完整上下文菜单、数量弹窗、拖拽重排和反馈 polish。
