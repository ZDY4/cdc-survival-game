...
- [~] 背包堆叠、拾取、丢弃、使用、装备/卸下；选中物品操作栏第一版已覆盖数量、使用、装备和丢弃。
...
- [~] item count、堆叠、拾取、丢弃。
- [~] UI 列表、详情、基础使用/装备入口；选中物品操作栏已提供数量 SpinBox、使用、装备、丢弃按钮。
...
- [ ] `AI`：感知、追击、攻击、回合、日程。
- [~] `InventoryUI`：使用、装备、丢弃、丢弃数量、排序、筛选、搜索、详情、顺序视图拖拽重排第一版已迁移；待补完整上下文菜单、数量弹窗、跨面板拖拽和反馈 polish。
