...
- [ ] 装备属性派生、装备外观挂点、耐久、损坏。
- [~] 容器权限/容量：锁、钥匙/工具、显式钥匙/工具消耗解锁、world flag、任务状态、NPC owner、关系门槛、允许偷窃、可配置偷窃关系后果和容量限制已有第一版；待补逐件工具耐久、NPC 目击、crime system、阵营敌对联动和更完整权限预览。
...
- [~] 容器权限：锁、钥匙/工具、显式钥匙/工具消耗解锁、world flag、任务状态、NPC owner、关系门槛、允许偷窃和可配置偷窃关系后果第一版已迁移；待补逐件工具耐久、NPC 目击、crime system、阵营敌对联动和更完整权限预览。
