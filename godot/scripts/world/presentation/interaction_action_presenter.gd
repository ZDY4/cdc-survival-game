...
func interaction_presentation(events: Array, world_root: Node, world_result: Dictionary) -> Dictionary:
...
func start_interaction_feedback(host: Node, world_root: Node, interaction: Dictionary) -> void:
