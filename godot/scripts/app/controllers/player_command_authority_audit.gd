...
const PLAYER_COMMAND_AUTHORITY_AUDIT: Array[Dictionary] = [
	{"app_method": "execute_primary_interaction", "owner_method": "request_player_interaction", "action": "interact", "authority_kind": "turn_action_runner", "command_kind": "interact", "owner": "PlayerCommandCoordinator", "blocker": "_player_command_rejection", "runner": "TurnActionRunner"},
	{"app_method": "execute_interaction_option", "owner_method": "request_player_interaction", "action": "interact_option", "authority_kind": "turn_action_runner", "command_kind": "interact", "owner": "PlayerCommandCoordinator", "blocker": "_player_command_rejection", "runner": "TurnActionRunner"},
	{"app_method": "execute_move_to_grid", "owner_method": "request_player_move", "action": "move", "authority_kind": "turn_action_runner", "command_kind": "move", "owner": "PlayerCommandCoordinator", "blocker": "_player_command_rejection", "runner": "TurnActionRunner"},
	{"app_method": "press_space_action", "owner_method": "press_space_action", "action": "wait_or_dialogue_advance", "authority_kind": "mixed", "command_kind": "wait", "core_service": "advance_dialogue.call", "owner": "PlayerCommandCoordinator", "blocker": "dialogue_or_pending_or_command", "runner": "TurnActionRunner", "authority_helper": "submit_wait"},
	{"app_method": "submit_wait_action", "owner_method": "request_player_wait", "action": "wait", "authority_kind": "turn_action_runner", "command_kind": "wait", "owner": "PlayerCommandCoordinator", "blocker": "_player_command_rejection", "runner": "TurnActionRunner"},
	{"app_method": "_submit_auto_tick_wait", "owner_method": "submit_auto_tick_wait", "action": "auto_wait", "authority_kind": "turn_action_runner", "command_kind": "wait", "owner": "PlayerCommandCoordinator", "blocker": "ui_or_pending", "runner": "TurnActionRunner"},
	...
	{"app_method": "craft_player_recipe", "owner_method": "request_player_craft", "action": "craft", "authority_kind": "turn_action_runner", "command_kind": "craft", "owner": "PlayerCommandCoordinator", "blocker": "_player_command_rejection", "runner": "TurnActionRunner"},
	{"app_method": "confirm_crafting_queue", "owner_method": "request_player_craft", "action": "crafting_queue", "authority_kind": "turn_action_runner", "command_kind": "craft", "owner": "PlayerCommandCoordinator", "blocker": "_player_command_rejection", "runner": "TurnActionRunner", "authority_helper": "advance_queue"},
	{"app_method": "cancel_pending_crafting", "owner_method": "cancel_pending", "action": "cancel_pending_crafting", "authority_kind": "core_service", "core_service": "Simulation.cancel_pending", "owner": "CraftingActionController", "blocker": "pending_crafting"},
