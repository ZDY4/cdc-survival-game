...
const PLAYER_COMMAND_AUTHORITY_AUDIT: Array[Dictionary] = [
	...
	{"app_method": "equip_player_item", "action": "equip", "authority_kind": "submit_player_command", "command_kind": "inventory_action", "inventory_action": "equip", "owner": "CharacterActionController", "blocker": "_submit_inventory_action"},
	{"app_method": "unequip_player_slot", "action": "unequip", "authority_kind": "submit_player_command", "command_kind": "inventory_action", "inventory_action": "unequip", "owner": "CharacterActionController", "blocker": "_submit_inventory_action"},
	{"app_method": "reload_player_equipped_slot", "action": "reload_equipped", "authority_kind": "submit_player_command", "command_kind": "inventory_action", "inventory_action": "reload_equipped", "owner": "CharacterActionController", "blocker": "_submit_inventory_action"},
	{"app_method": "allocate_player_attribute_point", "action": "allocate_attribute", "authority_kind": "core_service", "core_service": "Simulation.allocate_attribute_point", "owner": "CharacterActionController", "blocker": "attribute_points"},
	{"app_method": "learn_player_skill", "action": "learn_skill", "authority_kind": "submit_player_command", "command_kind": "learn_skill", "owner": "SkillActionController", "blocker": "_player_command_rejection"},
	{"app_method": "bind_player_skill_to_hotbar", "action": "bind_skill_hotbar", "authority_kind": "submit_player_command", "command_kind": "bind_hotbar", "owner": "SkillActionController", "blocker": "_player_command_rejection"},
	{"app_method": "bind_player_item_to_hotbar", "action": "bind_item_hotbar", "authority_kind": "submit_player_command", "command_kind": "bind_hotbar", "owner": "SkillActionController", "blocker": "_player_command_rejection"},
	{"app_method": "set_hotbar_group", "action": "set_hotbar_group", "authority_kind": "core_service", "core_service": "Simulation.set_active_hotbar_group", "owner": "SkillActionController", "blocker": "world_action_presenter"},
	{"app_method": "set_hotbar_group_label", "action": "set_hotbar_group_label", "authority_kind": "core_service", "core_service": "Simulation.set_hotbar_group_label", "owner": "SkillActionController", "blocker": "hotbar_group"},
	{"app_method": "cycle_hotbar_group", "action": "cycle_hotbar_group", "authority_kind": "core_service", "core_service": "Simulation.cycle_hotbar_group", "owner": "SkillActionController", "blocker": "world_action_presenter"},
