...
func _validate_reason_catalog() -> Array[String]:
	...
	var expectations := {
		...
		"observe_mode_blocks_player_commands": ["ui", "观察模式中", "observe_mode", "观察模式中不可操作玩家"],
		...
		"equipment_slot_incompatible": ["equipment", "物品不能装备到该槽位", "equip_slots", "物品不能装备到该槽位"],
