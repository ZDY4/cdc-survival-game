...
const REASONS := {
	...
	"interaction_target_consumed": {"category": "interaction", "text": "目标已被处理"},
	"actor_id_missing": {"category": "interaction", "text": "缺少目标角色"},
	"unknown_actor_target": {"category": "interaction", "text": "未知目标角色"},
	"unknown_self_target": {"category": "interaction", "text": "未知自身目标"},
	"grid_target_missing": {"category": "interaction", "text": "缺少目标格"},
	"map_object_target_missing": {"category": "interaction", "text": "缺少地图目标"},
	"unknown_map_object_target": {"category": "interaction", "text": "未知地图目标"},
	"unknown_interaction_target_type": {"category": "interaction", "text": "未知目标类型"},
	...
	"observe_hotbar_drag_unsupported": {"category": "ui", "text": "观察控制不支持拖拽放置"},
...
const REASON_METADATA := {
	...
	"observe_hotbar_drag_unsupported": {
		"payload_fields": ["drag_kind", "observe_key"],
		"disabled_text": "不能拖到观察控制",
	},
	"skill_on_cooldown": {
