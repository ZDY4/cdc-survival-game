...
use game_data::{
    ...
    CharacterInteractionProfile, CharacterLootEntry, DialogueAction, DialogueData, DialogueLibrary,
    DialogueNode, DialogueOption, DialogueRuleConditions, DialogueRuleDefinition,
    DialogueRuleLibrary, DialogueRuleVariant, GridCoord, InteractionExecutionRequest,
    InteractionOptionDefinition, InteractionOptionId, InteractionOptionKind, InteractionTargetId,
    ItemDefinition, ItemFragment, ItemLibrary, MapBuildingLayoutSpec, MapBuildingProps,
    MapBuildingStairSpec, MapBuildingStorySpec, MapCellDefinition, MapDefinition,
    ...
    RelativeGridCell, SkillActivationDefinition, SkillActivationEffect, SkillDefinition,
