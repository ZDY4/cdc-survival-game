...
use super::super::{
    AiBehaviorProfileComponent, NeedState, NpcActiveOfflineAction, NpcDecisionTrace,
    NpcLifeState, NpcPlannedActionQueue, NpcPlannedGoal, PersonalityState, ReservationState,
    ResolvedLifeProfileComponent, ScheduleState, SimClock,
    SmartObjectAccessProfileComponent, WorldAlertState,
};
...
pub(super) fn plan_npc_life_system(
    ...
    mut queries: ParamSet<(
        Query<(Entity, &NpcLifeState, &ScheduleState, &NpcActiveOfflineAction)>,
        Query<(
            Entity,
