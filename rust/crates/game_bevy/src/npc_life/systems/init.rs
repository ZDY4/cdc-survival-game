...
use crate::{
    AiDefinitions, SettlementDefinitions, SmartObjectReservations,
};

use super::super::helpers::*;
use super::super::{
    AiBehaviorProfileComponent, BackgroundLifeState, LifeProfileComponent, NeedState,
    NpcDecisionTrace, NpcLifeState, NpcPlannedActionQueue, NpcPlannedGoal,
    NpcRuntimeBridgeState, PersonalityState, ReservationState, ResolvedLifeProfileComponent,
    ScheduleState, SettlementContext, SettlementDebugSnapshot, SimClock,
...
pub(super) fn initialize_npc_life_entities(
    ...
    for (entity, profile_component) in &query {
        ...
        commands.entity(entity).insert((
            ...
            super::super::NpcActiveOfflineAction::default(),
