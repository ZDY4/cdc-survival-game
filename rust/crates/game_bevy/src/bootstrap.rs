...
use crate::{
    ...
    load_runtime_startup_config, resolve_startup_map_id, CharacterDefinitions,
    CharacterLoadError, MapDefinitions, MapLoadError, RuntimeBuildError, RuntimeScenarioSeed,
...
pub fn build_default_startup_seed(
    ...
    seed.map_id = resolve_startup_map_id(maps, startup_map);
    seed
}
