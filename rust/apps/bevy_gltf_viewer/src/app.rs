...
use crate::socket_editor::{
    ...
    sync_socket_editor_document_system, SocketEditorCommand, SocketEditorState,
};
use crate::state::{
    InitialModelSelection, PreviewCamera, PreviewState, ViewerAppState, ViewerAssetRoot,
    ViewerUiState, ViewerUiStyleState,
};
...
pub(crate) fn run(initial_model_path: Option<String>) {
    ...
    app.init_state::<ViewerAppState>()
        ...
        .add_message::<SocketEditorCommand>()
        ...
        .add_systems(
            ...
            (
                ...
                socket_editor_ui_system.run_if(in_state(ViewerAppState::Ready)),
            )
                .chain(),
        )
        .add_systems(
            ...
            (
                ...
                handle_socket_editor_commands_system,
                (
