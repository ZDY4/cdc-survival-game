//! 在线 NPC life 行动桥接模块。
//! 负责在线 NPC 的 life plan action bridge，不负责 presence 生命周期或战斗策略选择。

use bevy::prelude::*;
use game_bevy::{
    CharacterDefinitionId, GridPosition, NeedState, NpcActiveOfflineAction, NpcLifeState,
    NpcPlannedActionQueue, NpcRuntimeAiMode, NpcRuntimeBridgeState, ReservationState,
    RuntimeActorLink, SettlementDefinitions, SmartObjectReservations, WorldAlertState,
};
...
use super::{resolve_anchor_grid, resolve_reachable_runtime_grid};
